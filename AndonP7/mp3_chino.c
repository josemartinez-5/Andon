...
/* Funciones para el control del módulo de audio DFPlayer Mini
*/
...
#define  next 0x01
#define  previus 0x02
#define  archivo 0x03		//Parámetro de 0 a 2999
#define  volumen_sub 0x04
#define  volumen_baj 0x05
#define  volumen 0x06		//Parámetro de 0 a 30
#define  ecualizador 0x07
	#define  normal  0
	#define  pop      1
	#define  rock     2
	#define  jazz     3
 ...
 /* Comando 0x08 repite canción en / de acuerdo al parametro,
...
#define  carpeta  0x0F   	//Reproduce carpeta y canción seleccionada. DH=folder  DL=cancion  folder 01~99
#define  set_volumen 0x10	//Configuración de amplificación de audio
#define  repite_ya  0x011	//Parámetros: 1=repite cancion   0=para
